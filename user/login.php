            ...
            <div class="col col-xl-10">
                ...
                <div class="row g-0">
                    ...
                    <div class="card-body p-4 p-lg-5 text-black">
                        ...
                        <p class="mb-5 pb-lg-2" style="color: #393f81;">Don't have an account? <a href="daftar.php"
                        ...
                        <?php
                            if(isset($_POST['login'])){
                                ...
                                $query = mysqli_query($konek, "SELECT * FROM pembeli WHERE email_pembeli = '$email' AND pass_pembeli = '$pass'");
                                $dataakun = mysqli_num_rows($query);
                                $pecah = mysqli_fetch_assoc($query);

                                if($dataakun == 1){
                                    $_SESSION['pembeli'] = $pecah;
